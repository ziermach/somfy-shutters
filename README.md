...
669 backend and 77 frontend tests, against the real API surface, the tracker's rules,
...
```bash
cd backend && .venv/bin/python -m pytest       # 669 tests
cd frontend && npx vitest run                  # 77 tests
